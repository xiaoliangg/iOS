    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        case .waitlistInformation:
            ...
            case .shouldNotifyWhenAvailable:
                ...
                if let shouldNotify = UserDefaults.app.value(forKey: UserDefaultsWrapper<Any>.Key.showWaitlistNotification.rawValue) as? Bool {
...
extension UserDefaultsWrapper {
    ...
    public static func clearWaitlistValues() {
        UserDefaults.app.removeObject(forKey: UserDefaultsWrapper.Key.showWaitlistNotification.rawValue)
    }
